...
import { addNoticeFields } from "../../../../utility/fieldData";
const fields = [
  {
    type: "text",
    name: "title",
...
const UpdateNotice = () => {
  ...
  const handleNotice = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`http://localhost:3000/updateNotice/${id}`, {
          method: "PATCH",
          headers: {
  ...
  return (
    <div>
      ...
      <div className="w-full lg:py-20 px-5 lg:px-28">

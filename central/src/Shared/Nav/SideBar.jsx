  ...
  return (
    <div className="drawer z-[1200]">
      ...
      <div className="drawer-side">
        ...
        <ul
          className={`menu select-none  h-full overflow-auto flex w-72 p-4 relative bg-gradient-to-b from-[#D8EFD3] from-10% via-[#AAD7D9] via-60% to-[#222831] text-black ${
            isChecked ? "pt-12" : ""
          }`}
        >
          {/* In General Route */}
    ...
    children: [
      {
        ...
        icon: "FaUserGraduate",
        pack: "fa",
        path: "students/batch/B210305",
      },
      {
        name: "12 Batch",
        icon: "FaUserGraduate",
        pack: "fa",
        path: "students/batch/B200305",
      },
      {
        name: "11 Batch",
        icon: "FaUserGraduate",
        pack: "fa",
        path: "students/batch/B190305",
      },
      {
        name: "10 Batch",
        icon: "FaUserGraduate",
